	...
	<div class="row">
		...
		<div class="span9">
			<ul class="breadcrumb">
				...
				<li><a href="#" onclick="history.go(-1)">Sản phẩm</a> <span
									...
									<form class="form-horizontal qtyFrm">
										...
										<div class="btn-group">
											<a href="<c:url value="/AddCart/${ item.id_product }"/>" class="defaultBtn"><span
												class=" icon-shopping-cart"></span> Thêm vào giỏ hàng</a> <a
												href="<c:url value="/chi-tiet-san-pham/${ item.id_product }"/>" class="shopBtn">Xem</a>
										</div>
									</form>
								</div>
							</div>
