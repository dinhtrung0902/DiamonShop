			...
			<hr class="soft" />
				<div class="span4">
					<div class="well">
						<h5>Đăng nhập</h5>
						<h1>${ statusLogin }</h1>
						<form:form action="dang-nhap" method="POST" modelAttribute="user" accept-charset="utf-8">
							...
							<div class="control-group">
								<div class="controls">
									...
									<label class="control-label">Chưa có tài khoản?</label>
									<a href="dang-ky" class="defaultBtn">Đăng ký ngay</a>
								</div>
							</div>
						</form:form>
					</div>
